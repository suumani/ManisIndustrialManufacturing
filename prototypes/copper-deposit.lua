...
data.raw.planet.nauvis.map_gen_settings.autoplace_controls["copper-deposit"] = {}
data.raw.planet.nauvis.map_gen_settings.autoplace_settings.entity.settings["copper-deposit"] = {}
...
data:extend {{
    type = "resource",
    name = "copper-deposit",
    icon = "__ManisIndustrialManufacturing__/graphics/icons/copper-deposit.png",
    icon_size = 32,
    ...
    stages = {
        sheet = {
            filename = "__ManisIndustrialManufacturing__/graphics/entity/copper-deposit.png",
            priority = "extra-high",
            width = 128,
            height = 128,
            frame_count = 8,
